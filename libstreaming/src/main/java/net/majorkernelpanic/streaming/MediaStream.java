...
public abstract class MediaStream implements Stream {
    ...
    static {
        ...
        try {
            ...
            Log.i(TAG, "Phone supports the MediaCoded API"+ " sSuggestedMode is " + sSuggestedMode);
    ...
    public MediaStream() {
        Log.i(TAG,"MediaStream");
        mRequestedMode = sSuggestedMode;
        mMode = sSuggestedMode;
        Log.i(TAG,"MediaStream,mMode is " + mMode + " mRequestedMode is " + mRequestedMode);
    }
    ...
    public synchronized void configure() throws IllegalStateException, IOException {
        ...
        Log.i(TAG,"configure,mMode is " + mMode);
        mConfigured = true;
    }
